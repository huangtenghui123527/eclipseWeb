...
--demo site
INSERT INTO e_resource (id,created_time,creator_id,modified_time,modifier_id,available,name,parent_id,permission,resource_type,url,cls,lable_key,sort_num,access_code,system_id)  VALUES ('com_xx_demo_test_site',NULL,NULL,NULL,NULL,1,'站点','demo',NULL,'MENU','demo-ui/demo/test/site_index.html','menu-icon fa fa-caret-right','menu.demo.test.site_manage',20,NULL,'demo');
INSERT INTO e_role_resource (role_id,resource_id) VALUES ('ADMIN','com_xx_demo_test_site');
INSERT INTO e_menu_i18n (id,key_,lang_,value_,system_code) VALUES ('menu.demo.test.site_manage','menu.demo.test.site_manage','','站点管理','demo');
INSERT INTO e_menu_i18n (id,key_,lang_,value_,system_code) VALUES ('menu.demo.test.site_manage_zh_CN','menu.demo.test.site_manage','zh_CN','站点管理','demo');
INSERT INTO e_menu_i18n (id,key_,lang_,value_,system_code) VALUES ('menu.demo.test.site_manage_en_US','menu.demo.test.site_manage','en_US','Site MGT','demo');


INSERT INTO e_resource (id,created_time,creator_id,modified_time,modifier_id,available,name,parent_id,permission,resource_type,url,cls,lable_key,sort_num,access_code,system_id)  VALUES ('com_xx_demo_test_site_add',NULL,NULL,NULL,NULL,1,'新增','com_xx_demo_test_site',NULL,'BUTTON','site/save',NULL,'menu.add',NULL,'site:save','demo');
INSERT INTO e_resource (id,created_time,creator_id,modified_time,modifier_id,available,name,parent_id,permission,resource_type,url,cls,lable_key,sort_num,access_code,system_id)   VALUES ('com_xx_demo_test_site_edit',NULL,NULL,NULL,NULL,1,'编辑','com_xx_demo_test_site',NULL,'BUTTON','site/update',NULL,'menu.edit',NULL,'site:update','demo');
INSERT INTO e_resource (id,created_time,creator_id,modified_time,modifier_id,available,name,parent_id,permission,resource_type,url,cls,lable_key,sort_num,access_code,system_id)   VALUES ('com_xx_demo_test_site_delete',NULL,NULL,NULL,NULL,1,'删除','com_xx_demo_test_site',NULL,'BUTTON','site/del',NULL,'menu.delete',NULL,'site:del','demo');

INSERT INTO e_role_resource (role_id,resource_id) VALUES ('ADMIN','com_xx_demo_test_site_add');
INSERT INTO e_role_resource (role_id,resource_id) VALUES ('ADMIN','com_xx_demo_test_site_edit');
INSERT INTO e_role_resource (role_id,resource_id) VALUES ('ADMIN','com_xx_demo_test_site_delete');
--demo customer
